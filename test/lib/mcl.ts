// From:
// https://raw.githubusercontent.com/thehubbleproject/hubble-contracts/69ffbedb7f361a8b442828ebb7c4075f69fd318c/ts/mcl.tss
const mcl = require('mcl-wasm')
import { ethers, isHexString } from 'ethers'
import { hexlify } from 'ethers'
import { toBig, FIELD_ORDER, randHex, bigmod } from './utils'
...
export function mapToPoint(eHex: string) {
    const e0 = toBig(eHex)
    let e1 = new mcl.Fp()
    e1.setStr(bigmod(e0, FIELD_ORDER).toString())
    return e1.mapToG1()
}
